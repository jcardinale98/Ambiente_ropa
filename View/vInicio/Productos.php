...
<body>
    ...
    <header class="encabezado">
        ...
        <a href="Principal.php" class="text-decoration-none text-dark d-inline-block">
            <div class="d-flex align-items-center gap-3 mb-3">
                <div class="d-flex align-items-center justify-content-center
                      bg-dark text-white rounded-circle shadow-sm" style="width: 48px; height: 48px;">
                    <i class="fa fa-shopping-bag fa-lg"></i>
                </div>

                <div>
                    <h1 class="titulo-productos fw-bold mb-0">
                        Nuestros productos
                    </h1>
