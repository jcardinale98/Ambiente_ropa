$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (respuesta) {
        if (parseInt(respuesta.Resultado) === 1) {
          ...
          setTimeout(function () {
            window.location.href = "/Ambiente_ropa/View/vInicio/Principal.php";
          }, 1500);
        } else {
          ...
          boton.html('<i class="fa-solid fa-check"></i> ' + "Confirmar compra");
        }
      },
      ...
      error: function (xhr) {
        ...
        MostrarMensaje("No se pudo confirmar la compra.", false);
  ...
  $(".btn-modificar").click(function () {
    ...
    const cantidad = parseInt($("#cantidad_" + producto).val());
    ...
    $.ajax({
      ...
      error: function (xhr) {
        ...
        MostrarMensaje("No se pudo modificar la cantidad.", false);
      },
    });
  });
  ...
  $(".btn-eliminar").click(function () {
    ...
    $.ajax({
      ...
      error: function (xhr) {
        ...
        MostrarMensaje("No se pudo eliminar el producto.", false);
      },
    });
  });
  ...
  $("#btnVaciarCarrito").click(function () {
    ...
    $.ajax({
      ...
      error: function (xhr) {
        ...
        MostrarMensaje("No se pudo vaciar el carrito.", false);
      },
    });
  });
});
