    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-4">
        ...
        <div class="d-flex justify-content-end align-items-center">
          ...
          <a href="Carrito.php" title="Carrito" class="text-dark me-3">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow p-2" aria-labelledby="dropdownUsuario">
              ...
              <li>
                ...
                <a class="dropdown-item rounded py-2" href="Principal.php">
              ...
              <li>
                ...
                <a class="dropdown-item rounded py-2" href="Productos.php">
              ...
              <li>
                ...
                <a class="dropdown-item rounded py-2" href="Carrito.php">
          ...
          <a href="/Ambiente_ropa/Controller/CerrarSessionController.php" class="btn btn-outline-danger btn-sm ms-3">
