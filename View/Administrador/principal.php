    ...
    <div class="card shadow">
      ...
      <div class="card-body p-5">
        ...
        <div class="d-flex flex-wrap gap-3">
          ...
          <a class="btn btn-outline-dark" href="/AMBIENTE_ROPA/View/vGestion/GestionProductos.php">
            Gestionar productos
          </a>

          <a class="btn btn-outline-dark" href="/AMBIENTE_ROPA/View/vGestion/GestionCategorias.php">
